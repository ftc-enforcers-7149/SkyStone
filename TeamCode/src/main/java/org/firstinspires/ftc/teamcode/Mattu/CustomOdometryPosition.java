...
public class CustomOdometryPosition extends Position {

    //Declaring motors
    private CustomEncoder encoderY, encoderX;
    ...
    //Constructor
    public CustomOdometryPosition() {
        positionX = 0;
        positionY = 0;
    }

    public CustomOdometryPosition(HardwareMap hardwareMap, double posX, double posY, Gyroscope gyro) {

        encoderX = new CustomEncoder(hardwareMap, "encXA", "encXB");
        encoderY = new CustomEncoder(hardwareMap, "encYA", "encYB");

        encoderX.setDir(CustomEncoder.Direction.FORWARD);
        encoderY.setDir(CustomEncoder.Direction.REVERSE);
    ...
    public CustomOdometryPosition(HardwareMap hardwareMap, double posX, double posY, Gyroscope gyro, DcMotor fLeft, DcMotor fRight, DcMotor bLeft, DcMotor bRight) {
    ...
    public double getRawX() {
        return encoderX.getCounts();
    }

    public double getRawY() {
        return encoderY.getCounts();
    }
    ...
    public void updatePosition(Direction dir) {
        ...
        double yDisp = encoderY.getCounts();
        double xDisp = encoderX.getCounts();
    ...
    public void reverseX() {
        encoderX.setDir(CustomEncoder.Direction.REVERSE);
    }
